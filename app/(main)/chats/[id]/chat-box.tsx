    ...
    <div className="mx-auto mb-5 flex w-full max-w-prose shrink-0 px-8">
      ...
      >
        <fieldset className="w-full" disabled={disabled}>
          <div className="relative flex rounded-lg border-0 bg-[#6E706D]">
            <TextareaAutosize
              ref={textareaRef}
              ...
              rows={2}
              minRows={2}
              className="peer relative w-full resize-none text-white bg-transparent p-2 placeholder-white focus:outline-none disabled:opacity-50"
              onKeyDown={(event) => {
