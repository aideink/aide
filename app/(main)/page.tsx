...
export default function Home() {
  ...
  return (
    <div className="relative flex grow flex-col">
      <div className="absolute inset-0 flex justify-center aideglow">
        {/*<Image
          src={bgImg}
          alt=""
      ...
      <div className="isolate flex h-full grow flex-col">
        ...
        <div className="mt-10 flex grow flex-col items-center px-4 lg:mt-16">
          ...
          <h1 className="mt-4 text-balance text-center text-4xl leading-none text-white md:text-[64px] lg:mt-8">
            Turn your <span className="text-white">idea</span>
          ...
          >
            <Fieldset>
              <div className="relative flex rounded-xl border-0  bg-[#6E706D] pb-10">
                <div className="w-full">
                  ...
                  <TextareaAutosize
                    placeholder="State the application and logic you want..."
                    required
                    name="prompt"
                    rows={1}
                    className="peer relative w-full text-white resize-none bg-transparent p-3 placeholder-white focus-visible:outline-none disabled:opacity-50"
                    value={prompt}
              ...
              <div className="mt-4 flex w-full flex-wrap justify-center gap-3">
                {SUGGESTED_PROMPTS.map((v) => (
                  <button
                    ...
                    className="rounded bg-[#05414D] text-white px-2.5 py-1.5 text-xs hover:bg-[#05414D] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-300"
                  >
                    {v.title}
                  </button>
                ))}
        ...
        <footer className="flex w-full flex-col items-center justify-center space-y-3 px-3 pb-3 pt-5 text-center sm:flex-row sm:pt-2">
          <div className="text-xs text-white">
            <div>CA: 6MhvExQZPnvY1R13kwq4DSVotf7PMtXnELJ4JLG4pump</div>
            <div>GitHUB: https://github.com/aideink</div>
            <div>Twitter: https://x.com/aide_ink</div>
          </div>
